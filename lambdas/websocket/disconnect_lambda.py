...
event = {
    'headers': {
        'Host': '6t7ekp92lc.execute-api.us-east-1.amazonaws.com',
        'x-api-key': '',
        'X-Forwarded-For': '',
        'x-restapi': ''},
    'multiValueHeaders': {
    ...
    'requestContext': {
        ...
        'extendedRequestId': 'OxxXgGPmoAMFiQQ=',
        'requestTime': '10/Mar/2022:17:03:31 +0000',
        'messageDirection': 'IN',
...
def disconnect(event, context):
    ...
    table: BatchWriter = boto3.resource(
        'dynamodb').Table('WebsocketConnectionManager')
