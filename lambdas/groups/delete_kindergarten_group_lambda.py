...
def group_is_empty(teacher_data: dict, group_name: str) -> bool:
    children = ChildrenHandler.get_children_for_kindergarten_and_group_no_photo_link(
        kindergarten_id=teacher_data[KINDERGARTEN_ID], group_name=group_name)
    teachers = TeacherHandler.get_all_teacher_in_group(teacher_data,group_name)
